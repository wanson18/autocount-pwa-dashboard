...
test('resource GET supports active-only and all-resource views', async () => {
  ...
  await handler(jsonRequest('PATCH', { type: 'driver', id: driverId, active: false }), deactivateRes);
  ...
  await handler(jsonRequest('PATCH', { type: 'driver', id: driverId, active: true }), reactivateRes);
